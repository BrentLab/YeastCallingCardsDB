...
from ..serializers import (ChipExo_s3Serializer,)
from ..filters import ChipExo_s3Filter


logger = logging.getLogger(__name__)


class ChipExo_s3ViewSet(ListModelFieldsMixin,
                        CustomCreateMixin,
                        PageSizeModelMixin,
                        CountModelMixin,
                        UpdateModifiedMixin,
    ...
    """
    API endpoint that allows ChipExo_s3 to be viewed or edited.
    """
    queryset = ChipExo_s3.objects.all().order_by('id')
    serializer_class = ChipExo_s3Serializer

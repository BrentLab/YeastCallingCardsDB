...
from ..serializers import (Hu_s3Serializer,)
from ..filters import Hu_s3Filter

logger = logging.getLogger(__name__)


class Hu_s3ViewSet(ListModelFieldsMixin,
                   CustomCreateMixin,
                   PageSizeModelMixin,
                   CountModelMixin,
                   UpdateModifiedMixin,
    ...
    """
    API endpoint that allows Hu_s3 to be viewed or edited.
    """
    queryset = Hu_s3.objects.all().order_by('id')
    serializer_class = Hu_s3Serializer
    authentication_classes = [SessionAuthentication, TokenAuthentication]
    permission_classes = [IsAuthenticated]
    filter_backends = (DjangoFilterBackend, SearchFilter)
    filterset_class = Hu_s3Filter
    ...
    def create(self, request, *args, **kwargs):
        ...
        required_columns = {'gene_id', 'effect', 'pval'}
